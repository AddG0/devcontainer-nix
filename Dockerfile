...
FROM ghcr.io/addg0/nix-community/nixpkgs/devcontainer:${NIXOS_VERSION}
...
ARG HOME_MANAGER_CHANNEL=https://github.com/nix-community/home-manager/archive/release-24.11.tar.gz 
